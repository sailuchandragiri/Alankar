...
const Lunch = () => {
    ...
    return (
        <div>
            <div className="box-content  h-66 w-100% p-4  ... bg-red-900 rounded-b-3xl">
                <div className=" mt-12 mb-8 flex ...">
                    ...
                    <div className=" ml-40 text-sm  text-right pt-3 text-gray-300 bg-red-900 flex-1 ...">LUNCH</div>
                </div>
            ...
            <div className="text-lg ml-6 text-bold mt-2 text-left text-gray-800">Our Dosa Mela Variations</div>
            <hr className="ml-4 w-96 mt-2" />
