        ...
        <div>
            <div className="box-content  h-48 w-100% p-4  ... bg-red-900 rounded-b-3xl">
                <div className=" mt-12 mb-8 flex ...">
                    ...
                    <div className=" ml-40 text-sm  text-right pt-3 text-gray-300 bg-red-900 flex-1 ...">DINNER</div>
                </div>
            ...
            <div className="text-lg ml-6 text-bold mt-2 text-left text-gray-800">Our Drinks Variations</div>
